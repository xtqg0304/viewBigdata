...
export default {
  ...
  methods: {
    getData () {
      this.loading = true;
      if (this.dormitoryLineData.chartData) {
        this.vChartOptions.title.text = this.dormitoryLineData.vChartOptions.title.text;
        this.chartData = this.dormitoryLineData.chartData.rows.length ? Object.assign({}, this.dormitoryLineData.chartData) : Object.assign({}, this.chartData);
  ...
  watch: {
    dormitoryLineData (oldValue, newValue) {
      this.getData();
    }
  }
}
