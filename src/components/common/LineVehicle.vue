...
export default {
  ...
  methods: {
    getData () {
      this.loading = true;
      if (this.trendVehicleLineData.chartData) {
        this.vChartOptions.title.text = this.trendVehicleLineData.vChartOptions.title.text;
        this.chartData = this.trendVehicleLineData.chartData.rows.length ? Object.assign({}, this.trendVehicleLineData.chartData) : Object.assign({}, this.chartData);
  ...
  watch: {
    trendVehicleLineData (oldValue, newValue) {
      this.getData();
    }
  }
}
