...
export default {
  ...
  methods: {
    getData () {
      this.loading = true;
      if (this.orderTrendFieldLineData.chartData) {
        this.vChartOptions.title.text = this.orderTrendFieldLineData.vChartOptions.title.text;
        this.chartData = this.orderTrendFieldLineData.chartData.rows.length ? Object.assign({}, this.orderTrendFieldLineData.chartData) : Object.assign({}, this.chartData);
  ...
  watch: {
    orderTrendFieldLineData (oldValue, newValue) {
      this.getData();
    }
  }
}
